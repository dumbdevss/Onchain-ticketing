...
class TypedStorage<T> {
	...
	constructor() {
		// SSR safety: `localStorage` only exists in the browser. Under Next.js
		// this module may be evaluated on the server during the initial render
		// of a client component's import graph, so guard the access.
		this.storage =
